...
class AssistantDashboard extends Component {
            ...
            <div className="relative w-full h-screen | p-4">
                ...
                <div className="flex items-center justify-between flex-col sm:flex-row | w-full | space-y-4 sm:space-y-0 sm:space-x-4 | mb-8">
                    ...
                    >
                        ...
                        <div>
                            <h4 className="text-2xl font-bold">Flights summary</h4>
                            <p className="text-xs text-gray-500">Flights count summarized by day</p>
                        </div>
                        ...
                        <ResponsiveContainer width="100%" height="100%">
                            <BarChart width={150} height={40} 
                                ...
                                data={
                                    this.context.agentDashboardPrimaryChart ? this.context.agentDashboardPrimaryChart.getDays(this.props.selectedDays, "Flights") : []
                                }
                            >
                                <XAxis dataKey="name" stroke="#000" />
                                <Tooltip wrapperStyle={{ width: 100, backgroundColor: '#ccc' }} />
                                <Bar dataKey="Flights" fill="#54daff" barSize={30} />
                            </BarChart>
                        </ResponsiveContainer>
                ...
                >
                    ...
                    <ResponsiveContainer width="100%" height="100%">
                        ...
                        >
                            ...
                            <Area type="monotone" dataKey="Bookings" fill="#8884d8" stroke="rgb(84, 218, 255)" />
...
AssistantDashboard.contextType = AppContext;
