...
class Navbar extends React.Component {
  ...
  render() {
    return (
      <Disclosure as="nav" className="bg-white h-14 w-full">
        {({ open }) => (
          <>
                  ...
                  <div className="hidden sm:block">
                    <div className="flex space-x-4">
                      ...
                      >
                        {
                          this.context.agent ? 
                            `${String(this.context.agent.type).toLowerCase().replace(/\b\w/g, l => l.toUpperCase())} ${
                              this.context.agent.type == "PROVIDER" ? `at ${this.context.agent.getAirportFullName()}` : ''
                            }`
                          : ''
                        }
                      </a>
