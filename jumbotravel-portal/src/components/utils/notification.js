...
class Notification extends Component {
    ...
    getSVG(severity) {
        ...
        if (!severity) {
            return (
                <svg className="w-5 h-5 text-blue-300 dark:text-blue-500" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="paper-plane" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        ...
        return (
            <div 
                ...
                className={classNames(
                    ...
                    "flex | cursor-pointer hover:shadow-md transition-all duration-200 ease-in-out | items-center w-full p-2 mb-2 text-gray-500 bg-white rounded-lg outline outline-2 dark:text-gray-400 dark:bg-gray-800"
                )}
                role="alert"
            >
                <div 
                    className={classNames(
                        ...
                        "inline-flex items-center justify-center flex-shrink-0 w-8 h-8 text-green-500 rounded-lg dark:bg-green-800 dark:text-green-200"
                    )}
                >
                    {
